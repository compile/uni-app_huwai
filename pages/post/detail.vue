	...
	<view>
		<view class="info-box">
			...
			<navigator class="topic-info" :url="'/pages/topic/detail?id=' + postDetail.topic_id">
				...
				<view class="center">
					<view class="desc">{{ postDetail.topicInfo.topic_name.substring(0, 15) }}</view>
					<view class="count-txt">{{ postDetail.topicInfo.user_count }}人加圈 | {{ postDetail.topicInfo.post_count }}篇内容</view>
				</view>
				<view class="right">
					<text>去看看</text>
